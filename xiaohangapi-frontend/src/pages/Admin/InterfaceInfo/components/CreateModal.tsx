...
const CreateModal: React.FC<Props> = (props) => {
    ...
    return (
      <DrawerForm<API.InterfaceInfoVO>
        ...
        title={<span className="drawer-title"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 5v14M5 12h14"/></svg>Add New Interface</span>}
        open={visible}
      >
        <ProFormText
          name="name"
