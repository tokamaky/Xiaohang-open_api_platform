...
-- Insert Sample Data
INSERT INTO yuapi.`interface_info` (`name`, `description`, `url`, `requestHeader`, `responseHeader`, `status`, `method`, `userId`)
VALUES
    ('Xu Qingyu', 'Xue Congjian', 'www.cary-king.net', 'Pan Botao', 'Tan Congjian', 0, 'Shi Xuanming', 9500534531),
    ...
    ('Fu Zhiqiang', 'Chen Zichen', 'www.jordan-reinger.com', 'Jin Zhiqiang', 'Xiong Jincheng', 0, 'Deng Ruiyuan', 35542559),
    ...
    ('Xiao Jiayi', 'Cao Yitong', 'www.margarette-lindgren.biz', 'Tian Zeyang', 'Deng Ruiyuan', 0, 'Liang Zhiqiang', 98),
    ...
    ('Wei Zhiqiang', 'Yu Licheng', 'www.ione-aufderhar.biz', 'Zhu Yixuan', 'Wan Zhiyuan', 0, 'Tang Haoqiang', 741098),
