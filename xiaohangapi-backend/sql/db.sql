...
CREATE TABLE `interface_info` (
                                  ...
                                  `description` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Description',
                                  `url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Interface URL',
                                  `host` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Host name',
                                  `requestParams` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Request parameters',
                                  `requestParamsRemark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Request parameter description',
                                  `responseParamsRemark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Response parameter description',
                                  `requestHeader` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Request headers',
                                  `responseHeader` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'Response headers',
                                  `status` int NOT NULL DEFAULT 0 COMMENT 'Interface status (0 - closed, 1 - open)',
                                  `method` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Request method',
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Interface information' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user` (
                        ...
                        `userAccount` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Account',
                        `userPassword` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Password',
                        `userName` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'User nickname',
                        `userAvatar` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'User avatar',
                        `userProfile` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'User profile description',
                        ...
                        `isDelete` tinyint NOT NULL DEFAULT 0 COMMENT 'Is deleted (0 - not deleted, 1 - deleted)',
                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1668967663894642689 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'User table' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1667508636207661058, 'nero', '40576063cc4e128bee21f333df54d346', 'Nero', 'https://yupao-project-ichensw.oss-cn-hangzhou.aliyuncs.com/PEej0vHQ-4.jpg', NULL, 'admin', '53349ea7504b8985606a8edbda11e314', '82b9389e40dd4c589feebd12fe60786a', '2023-06-10 20:26:54', '2023-07-10 23:12:03', 0);
INSERT INTO `user` VALUES (1668967663894642689, 'niko', '40576063cc4e128bee21f333df54d346', 'Niko', 'https://image-bed-ichensw.oss-cn-hangzhou.aliyuncs.com/006VVqOWgy1h43uaynbyxj30go0go0u7.jpg', NULL, 'user', '6ab93d6aae79d390562ec73127c7446c', '95848fadb0461070537d9a519e71e22c', '2023-06-14 21:04:33', '2023-06-14 21:10:18', 0);
...
CREATE TABLE `user_interface_info` (
                                       `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
                                       `userId` bigint NOT NULL COMMENT 'User ID making the call',
                                       `interfaceInfoId` bigint NOT NULL COMMENT 'Interface ID',
                                       `totalNum` int NOT NULL DEFAULT 0 COMMENT 'Total number of calls made',
                                       `leftNum` int NOT NULL DEFAULT 0 COMMENT 'Remaining number of calls available',
                                       `status` int NOT NULL DEFAULT 0 COMMENT '0 - Active, 1 - Disabled',
                                       `createTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation time',
                                       `updateTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last update time',
                                       `isDelete` tinyint NOT NULL DEFAULT 0 COMMENT 'Is deleted (0 - Not deleted, 1 - Deleted)',
                                       PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'User interface call relationship' ROW_FORMAT = Dynamic;
